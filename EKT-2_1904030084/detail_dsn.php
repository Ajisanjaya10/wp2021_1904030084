...
$nind = $_GET['nind'];
$camaba = query("SELECT * FROM tabel_dsn WHERE nind=$nind");
//var_dump($camaba)
 ?>
...
<ul class = "list-group">
  ...
  <a href="dosen.php?nind=delete&nind=<?php echo $nind?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-primary">Hapus</button></a>
