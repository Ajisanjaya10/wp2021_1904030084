...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="page-section" id="services">
      ...
      <ul class="list-group">
        <li class="list-group-item active"><?= $camaba['id_anggota']; ?></li>
        <li class="list-group-item">Nama : <?= $camaba['nama_anggota']; ?></li>
        <li class="list-group-item">Alamat : <?= $camaba['alamat']; ?></li>
        <li class="list-group-item">No Telepon : <?= $camaba['no_telp']; ?></li>
        <li class="list-group-item">Tanggal Lahir : <?= $camaba['tgl_lahir']; ?></li>
        <li class="list-group-item"><img src="image/<?= $camaba['foto']; ?> "width="120px"></li>
        <li class="list-group-item">
          <a href="edit_anggota.php?id_anggota=<?= $camaba['id_anggota']; ?>" class="btn btn-warning" role="button">Edit</a> |
          <a href="hapus.php?id_anggota=<?= $camaba['id_anggota']; ?>" onclick="return confirm" class="btn btn-danger" role="button">Hapus</a> |
