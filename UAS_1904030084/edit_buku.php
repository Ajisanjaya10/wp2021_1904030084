...
$camaba = query("SELECT * FROM buku WHERE id_buku = $id_buku");
    ...
    <section class="page-section" id="services">
      <div class="container">
        <div class="text-center">
          ...
          <h3 class="section-subheading text-muted">Daftar Buku</h3>
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama_buku" value="<?= $camaba['nama_buku'] ?>" placeholder="nama_buku" name="nama" autofocus required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="jenis_buku">Jenis Buku : </label>
          <input type="text" class="form-control" id="jenis_buku" value="<?= $camaba['jenis_buku'] ?>" placeholder="jenis_buku lengkap" name="jenis_buku" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="pengarang_buku">Pengarang Buku : </label>
          <input type="text" class="form-control" id="pengarang_buku" value="<?= $camaba['pengarang_buku'] ?>" placeholder="pengarang_buku" name="pengarang_buku" required autocomplete="off">
        </div>

        <div class="form-group">
          <label for="gambar">Foto : </label>
          <input type="text" class="form-control" id="gambar" value="<?= $camaba['gambar'] ?>" placeholder="input foto anda" name="gambar" required autocomplete="off">
        </div>
