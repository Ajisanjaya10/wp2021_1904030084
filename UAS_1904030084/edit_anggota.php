...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="page-section" id="services">
      ...
      <!-- konten -->
      <h3><i class="fas fa-users"></i> Edit Anggota</h3>
      <hr>
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nama_anggota" value="<?= $camaba['nama_anggota'] ?>" placeholder="nama_anggota" name="nama" autofocus required autocomplete="off">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="no_telp" value="<?= $camaba['no_telp'] ?>" placeholder="jenis kelamin" name="no_telp" required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="tgl_lahir">Taggal Lahir : </label>
          <input type="text" class="form-control" id="tgl_lahir" value="<?= $camaba['tgl_lahir'] ?>" placeholder="tanggal lahir anda" name="tgl_lahir" required autocomplete="off">
        </div>
