...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="page-section bg-light" id="portfolio">
      ...
      <ul class="list-group">
        <li class="list-group-item active"><?= $camaba['id_buku']; ?></li>
        <li class="list-group-item">Judul Buku : <?= $camaba['nama_buku']; ?></li>
        <li class="list-group-item">Jenis Buku : <?= $camaba['jenis_buku']; ?></li>
        <li class="list-group-item">Pengarang Buku : <?= $camaba['pengarang_buku']; ?></li>
        <li class="list-group-item"><img src="image/<?= $camaba['gambar']; ?> "width="120px"></li>
        <li class="list-group-item">
          <a href="edit_buku.php?id_buku=<?= $camaba['id_buku']; ?>" class="btn btn-warning" role="button">Edit</a> |
          <a href="hapus.php?id_buku=<?= $camaba['id_buku']; ?>" onclick="return confirm" class="btn btn-danger" role="button">Hapus</a> |
